    ...
    public partial class KingWilliamHotelDBDataSet : global::System.Data.DataSet {
        ...
        public partial class tblGuestsRow : global::System.Data.DataRow {
            ...
            public string Gender {
                get {
                    return ((string)(this[this.tabletblGuests.GenderColumn]));
                }
                set {
...
SELECT EmployeeID, HireDate, EndDate FROM tblEmployeeHistory WHERE (EmployeeID = @EmployeeID) AND (HireDate = @HireDate)";
    ...
    public partial class tblGuestsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tblGuests] WHERE (([GuestID] = @Original_GuestID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([GuestAddress] = @Original_GuestAddress) AND ([Gender] = @Original_Gender) AND ([Phone] = @Original_Phone) AND ([EmailAddress] = @Original_EmailAddress))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand.CommandText = @"
						INSERT INTO [dbo].[tblGuests] ([GuestID], [FirstName], [LastName], [GuestAddress], [Gender], [Phone], [EmailAddress]) VALUES (@GuestID, @FirstName, @LastName, @GuestAddress, @Gender, @Phone, @EmailAddress);
						SELECT GuestID, FirstName, LastName, GuestAddress, Gender, Phone, EmailAddress FROM tblGuests WHERE (GuestID = @GuestID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tblGuests] SET [GuestID] = @GuestID, [FirstName] = @FirstName, [LastName] = @LastName, [GuestAddress] = @Gender, [Gender] = @Gender, [Phone] = @Phone, [EmailAddress] = @EmailAddress WHERE (([GuestID] = @Original_GuestID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([GuestAddress] = @Original_GuestAddress) AND ([Gender] = @Original_Gender) AND ([Phone] = @Original_Phone) AND ([EmailAddress] = @Original_EmailAddress));
SELECT GuestID, FirstName, LastName, GuestAddress, Gender, Phone, EmailAddress FROM tblGuests WHERE (GuestID = @GuestID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT GuestID, FirstName, LastName, GuestAddress, Gender, Phone, EmailAddress FR" +
                "OM dbo.tblGuests";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(string Original_GuestID, string Original_FirstName, string Original_LastName, string Original_GuestAddress, string Original_Gender, string Original_Phone, string Original_EmailAddress) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string GuestID, string FirstName, string LastName, string GuestAddress, string Gender, string Phone, string EmailAddress) {
            if ((GuestID == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string GuestID, string FirstName, string LastName, string GuestAddress, string Gender, string Phone, string EmailAddress, string Original_GuestID, string Original_FirstName, string Original_LastName, string Original_GuestAddress, string Original_Gender, string Original_Phone, string Original_EmailAddress) {
            if ((GuestID == null)) {
                throw new global::System.ArgumentNullException("GuestID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string GuestAddress, string Gender, string Phone, string EmailAddress, string Original_GuestID, string Original_FirstName, string Original_LastName, string Original_GuestAddress, string Original_Gender, string Original_Phone, string Original_EmailAddress) {
